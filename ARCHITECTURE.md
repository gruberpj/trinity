...
| Print PDF | `manuscript/Mystery_of_the_Trinity.pdf` — 88 pp, 4.25×6.875 in (EB Garamond) (matches MGS booklet), Baskerville substituted for Adobe Garamond Pro, 19/19 build checks, content parity PASS |
| Word doc | `manuscript/Mystery_of_the_Trinity.docx` — Garamond 12pt, 446 paragraphs, final-version layout (4.25x6.875 pages, front matter, TOC field, page breaks) |
| Cover | `work/cover/Mystery_of_the_Trinity_cover.pdf` — Lulu spread 8.9482×7.125 in, spine 0.1982 in (88 pp), full-bleed front image + overlaid title, Rublev front panel, back blurb |
