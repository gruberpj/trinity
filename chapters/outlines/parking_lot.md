# Parking Lot — Surplus Material Not Forced Into Chapters

**Created:** 2026-09-16 (Prompt G, epilogue draft). Append-only. Each entry: source, what was parked, why, and where it lives if re-adopted.

---

## Epilogue (E01 — Engineering Mystery)

Parked during drafting of `chapters/drafts/epilogue_engineering_mystery.md`:

1. **Eclipse 2017 tail clause** (E01 00:14:17) — "okay, so it should have been fun." Ambiguous ("fun" vs "fine", review Q18, human listen pending); the anecdote lands without it.
2. **"Thank you, everyone."** (E01 00:46:02) — talk-specific farewell; a book epilogue closes on the Glory Be.
3. **Quantum probe-heat detail** (E01 00:19:17) — "It imparts its heat as it absorbs that heat in some way, in order to take that measurement of the amount of heat in that system" — compressed to the core claim (measurement affects the measured); the ch. 2 qubit treatment covers the analogy at length.
4. **Full feedback-loop physics phrasing** (E01 00:34:56) — the speed-limit sentence trimmed; ch. 3 owns the full engineering explanation (cruise control, Tacoma Narrows, etc.).
5. **Morning-offering enumeration** (E01 00:36:35) — "whether explicitly, through some kind of morning offering, praying, or through the prayer of the Church, such as morning prayer, or a desire to go to Mass where you might make that more intentional, or something" — compressed to the three modes.
6. **Grammar aside fragment** (E01 00:28:44) — "Okay, so I'm going to — I've said anything, so I'm sorry." (review Q4, human listen pending) — dropped in the compressed *intimus* treatment.
7. **Moon-phase/shape enumeration** (E01 00:17:02) — "We can see at different times it actually is smaller, and the different shapes of the moon are because of where it is in relation to the sun and the earth" — compressed; the E01 moon telling otherwise kept in full.
...
## C01 (Icons of the Trinity)

Parked during drafting of `chapters/drafts/01_icons_of_the_trinity.md`:

1. **Extended mountain typology beyond Tabor** — 00:09:19–00:10:15.
   - Content: Mount Moriah (Isaac nearly sacrificed); Mount Sinai (the commandments; overshadowed in a cloud of glory while Moses communicated with God forty days and forty nights); Elijah fed by the bread and impelled to the still small voice on Sinai; Mount Carmel (also Elijah); Jesus praying at night in a little cave on the mountainside of the Sea of Galilee.
   - Reason parked: brief ch. 1 "excluded material" — keep only what serves the Spirit identification; the draft keeps the general claim ("A mountain is associated with the Holy Spirit"), "Mountains symbolize the Holy Spirit, prophecy," Tabor, and Calvary.
   - Reinstatement: author/voice reviewer may restore any piece if the fuller typology is wanted.

2. **The "you're permitted to groan" room aside** — 00:20:55.
   - Content (verbatim): "you guys are not audibly groaning. We're at 21 minutes and I'm sorry. But you're permitted to groan."
   - Reason parked: brief ch. 1 — keep only if voice review approves. Voice profile §9.1 generally protects such asides; the brief conditions this one on explicit approval.
...
Parked during drafting of `chapters/drafts/04_relationship.md`:

1. **2 Cor 12 "ninth [possibly: third] heaven" aside** (00:04:02) — retained in ch. 4 **in full, verbatim** (with the `[possibly: third]` flag), pending the voice reviewer's ruling. The brief's default is "trim unless the voice reviewer wants the humor" (chapter_briefs.md C04 "Excluded material"); the aside was kept intact because trimming authorial words is irreversible and the voice profile (§4.2) records it as a humor exemplar — but the trim decision is explicitly deferred to voice review, not waived. The "ninth vs third" word itself awaits human listening (C04 review Q2); the flag stays until then.
...
Parked during drafting of `chapters/drafts/02_mystery.md`:

1. **Qubit/quantum passage** (00:14:27–00:15:33) — parked per the brief: it duplicates E01's fuller treatment and echoes the unheard Ratzinger p. 175 observer passage. Cut between §12 ("How Far Analysis Goes") and §13 ("A Way of Approaching All Reality") as bridge B6; the talk's own join is clean, so no connective sentence was added.
   - Reinstatement: reinstate the span between §12 and §13 if the author wants the quantum analogy in ch. 2 — note it would then duplicate the epilogue's treatment.
2. **Stolen-bike "implicated" gloss** (00:07:54) — kept whole for voice (voice-consistent); the brief permits compressing it, and the voice reviewer may prefer the compressed form (voice-delta note). Not removed; compression is an option if global length requires.

Excluded (not parked; assembly-stage decision): Ratzinger p. 162 "mysterium" and p. 175 observer passages — DOCX-only, unheard in this talk (map structural flag; task instruction). Not drafted into ch. 2 prose.

---

## C03 (Gift and Liturgy)

Parked during drafting of `chapters/drafts/03_gift_and_liturgy.md`:
...
Kept with flags during drafting of `chapters/drafts/05_intimacy.md` (reviewers rule before approval):

1. **Protestant-conception framing** (00:01:06) — kept as heard; possible pastoral softening is an author decision per the brief — not deleted or softened silently.
2. **"That one thing is three — three persons and one God"** (00:21:04) — DOCTRINAL_REVIEW: rendered as the speaker's dramatized voice with the flag disclosed (the brief's second option); the theological reviewer must rule before approval.
3. **Ratzinger "fifth transcendental"** (00:07:14–00:11:13) — LOCATOR_MISSING; kept as heard paraphrase, no quotation marks, never asserted as verified. Author or researcher supplies the locator, or the prose stands as heard paraphrase.
4. **"Mount Sinai" (Horeb discrepancy)** (00:03:08) — kept as heard (Ex 3 locates the bush at Horeb; review Q3); any correction requires author approval per the brief.
5. **Augustine Ascension attribution** (00:17:00) — LOCATOR_MISSING / ATTRIBUTION_UNCONFIRMED; kept as heard with the in-prose marker `[quotation wording unverified]`. Cannot be printed as a quotation until located (author or researcher).

**C05 cross-chapter notes (not parked, tracked for assembly):**
- **Intimus etymology:** *intimus* also occurs in E01 00:28:15 — ch. 5 carries the full treatment (author decision #7); the epilogue compresses to a callback.
- **Ex 3:14 ledger pointer:** the drafting instruction's "SRC-047-ish" pointer does not match — SRC-047 is Gen 1:26 (C01). A ledger row is needed, or the DRA/Vulgate/CCC ¶206 rendering confirmed.
- **SRC-026 (Confessions I.1 "restless"):** listed in the drafting instruction but not heard in C05 audio; the ledger anchors it to E01. Not used in ch. 5.
- **"Everything is gift, everything is positive":** formula consistent with C03/C04 usage; no cross-chapter contradiction.
- **Mt 28:20 "with us always, even at the close of the age":** allusion within SRC-019's verified range; consistent with the SRC-019 anchors in C01/C06.

---

## C06 (Evangelization)

Parked during drafting of `chapters/drafts/06_evangelization.md`:

1. **The Passion of the Christ scene** (00:09:44) — brief-authorized trim (review Q14 — film-line wording discrepancy); keep only if the author wants the cultural aside.
2. **Deacon/priest joke** (00:08:47) — brief-authorized trim; reinstate only if voice review approves.
